# Angular - Pipes App
## AngularJs v18.2.11, - pipes de angular,  PRIME-NG

Este proyecto esta generado con: [Angular CLI](https://angular.dev/) version 18.2.11.

_Aplicacion desarrollada en Angular, para repasar concepto de pipes , se muestran cada uno de los pipes disponibles en angular, y hacemos el diseño de la maquetacion con PRIME-NG._
